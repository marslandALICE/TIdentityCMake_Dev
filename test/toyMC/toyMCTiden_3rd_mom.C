...
void toyMCTiden_3rd_mom()
{
  ...
  TTreeSRedirector *outputData = new TTreeSRedirector("DataTree_3D.root", "recreate");
  TTreeSRedirector *outputFits = new TTreeSRedirector("LineShapes_3D.root", "recreate");
